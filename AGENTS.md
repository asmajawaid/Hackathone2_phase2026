...
Phase-specific agents may exist, but they do not override this AGENTS.md.
All agents remain bound by this constitution.

## Skill System
Agents may only operate using approved skills defined in /skills.
Skills define WHAT an agent is allowed to do.